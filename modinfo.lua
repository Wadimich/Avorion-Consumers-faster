meta = {
    ...
    name = "FasterConsumerStations",

    -- Title of your mod that will be displayed to players
    title = "Faster Consumer Stations",

    -- Type of your mod, either "mod" or "factionpack"
    type = "mod",

    -- Description of your mod that will be displayed to players
    description = "Adds new types of consumer stations, which will consume products much faster",
